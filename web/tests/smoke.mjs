...
const e=g.state.enemies[0];e.alive=true;e.position={x:8,z:0};e.state='patrolling';e.detection=0;g.state.player.position={x:0,z:0};g.state.walls=[];g.emit('playerNoise',{position:{x:0,z:0},radius:10});ok(e.state==='alert','open hearing');
