...
function clearCampaignCorridor(walls,from,to,halfWidth=3){
  // Guarantee an L-shaped walkable route between consecutive objectives. Random walls still
  // fill the rest of the yard, but no generated map can seal off mandatory campaign progress.
