...
export const WORLD: WorldSpec = {
  ...
  droneSpecs: [
    ...
    { id: "hangar-sentinel", kind: "sentinel", route: [cellCenter(15, 14), cellCenter(9, 14), cellCenter(9, 3), cellCenter(15, 3)], speed: 88, hearingRadius: 320, sightRadius: 390 },
    { id: "shaft-sentinel", kind: "sentinel", route: [cellCenter(29, 6), cellCenter(19, 6), cellCenter(19, 2), cellCenter(29, 2)], speed: 84, hearingRadius: 330, sightRadius: 420 },
    { id: "cooling-listener", kind: "listener", route: [cellCenter(29, 14), cellCenter(19, 14), cellCenter(19, 10), cellCenter(29, 10)], speed: 80, hearingRadius: 520, sightRadius: 240 },
    { id: "machine-sentinel", kind: "sentinel", route: [cellCenter(29, 21), cellCenter(19, 21), cellCenter(19, 18), cellCenter(29, 18)], speed: 92, hearingRadius: 360, sightRadius: 400 },
